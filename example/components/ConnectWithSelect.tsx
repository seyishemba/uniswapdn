  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column' }}>
      ...
      {isActive ? (
        error ? (
          <button
          className="btn btn-icon rounded-full bg-green-600 hover:bg-green-700 border-green-600 hover:border-green-700 text-white conbtn"
          style={{zIndex: "1 !important"}}
          onClick={() => switchChain(desiredChainId)}>Error, Try again</button>
        ) : (
          <button
            onClick={() => {
